...
@section('content')
	        ...
	        <div class="col-md-8 col-md-offset-2">
	            ...
	            @foreach ($tasks as $task)
	            	<div class="panel panel-default">
                      ...
                      <div class="pull-right">
                        <form action="{{ route('post.showtask', $task) }}">
                          {{csrf_field()}}
  ...
  <!--Form Dalam Modal Delete -->
          <form role="form" action="{{ route('deletetask') }}" enctype="multipart/form-data" method="post">
            {{csrf_field()}}
            {{ method_field('DELETE') }}
  ...
  <!--Form Dalam Modal Update-->
        <form role="form" action="{{route('updatetask')}}" enctype="multipart/form-data" method="post">
        {{csrf_field()}}
          <div class="box-body">
              <div class="form-group">
                <input type="hidden" name="id" id="id" class="form-control" value="" readonly>
